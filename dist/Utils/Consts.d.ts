...
declare enum DBaaSUrls {
    Endpoint = "https://dbaas.gamesservice.ir"
}
declare enum CommandUrls {
    Endpoint = "ws://localhost:3004"
}
declare let Url: {
    Api: typeof ApiUrls;
    DBaaS: typeof DBaaSUrls;
    Command: typeof CommandUrls;
};
declare enum CommandActions {
    ActionAuth = 0,
    ActionAutoMatch = 1,
    ActionCreateRoom = 2,
    ActionGetRooms = 3,
...
declare let Actions: {
    Command: typeof CommandActions;
    TurnBased: typeof TurnBasedActions;
    RealTime: typeof RealTimeActions;
    Error: number;
};
export { Url, Actions };
